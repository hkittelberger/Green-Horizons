...
public class LobbyManager : MonoBehaviour
{
    ...
    public async void StartGame()
    {
        try
        {
            ...
            {
                Data = new Dictionary<string, DataObject> {
                    { KEY_START_GAME, new DataObject(DataObject.VisibilityOptions.Public, "true") }
                }
            });
            ...
            // LoadGameScene(); // This is commented out to prevent automatic scene loading
